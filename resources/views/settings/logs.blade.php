    ...
    <div class="max-w-4xl ">
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-bold text-gray-800">Laravel Logs</h1>
                <div class="space-x-2">
    ...
    <script>
        ...
        function clearLogs() {
            if (confirm('Are you sure you want to clear all logs?')) {
                ...
                // You might want to make an AJAX call to a backend route
        ...
        function downloadLogs() {
            ...
            a.href = url;
            a.download = `laravel-logs-${new Date().toISOString().split('T')[0]}.txt`;
