<x-admin-layout>
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6 flex justify-between items-center">
            <h2 class="text-2xl font-bold text-gray-800">Reviewed Enrollments</h2>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($reviewedEnrollments as $enrollment)
                        <tr class="hover:bg-gray-50 cursor-pointer"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $enrollment->updated_at->format('M d, Y H:i') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 py-1 text-sm rounded-full {{ $enrollment->status == 'approved' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
